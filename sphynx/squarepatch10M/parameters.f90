...
MODULE parameters
  ...
  LOGICAL :: dealloc, checkdens

  INTEGER,PARAMETER::nmax = 10077696 !Maximum number of particles
  ...
  INTEGER,PARAMETER::nodes=_NNN        !Amount of nodes.
  INTEGER,PARAMETER::dim = 3         !Spatial imensions
  INTEGER,PARAMETER::nnl = 2 !50000     !Iterations
  INTEGER,PARAMETER::iodelay = 1000  !Steps until output
  INTEGER,PARAMETER::dumpdelay = 5000!Steps until output of dumpfile
  ...
  INTEGER,PARAMETER::ncubes = 1      !Cubes for periodic BC
                                     !1 - No periodic BC
                                     !3 - North-south periodic BC in 3D
  ...
  DOUBLE PRECISION,PARAMETER::xbox=100.d0       !Box size x
  DOUBLE PRECISION,PARAMETER::ybox=100.d0       !Box size y
  DOUBLE PRECISION,PARAMETER::zbox=100.d0       !Box size z
  DOUBLE PRECISION,PARAMETER::pexp=0.d0       !Exponent for Volume Elements
  DOUBLE PRECISION,PARAMETER::ni0=500.d0      !Number of neighbors (fractional?)
  DOUBLE PRECISION,PARAMETER::nvmax=600.d0    !Maximum number of neighbors(Int.)
  DOUBLE PRECISION,PARAMETER::nvmin=300.d0    !Minimum number of neighbors(Int.)
  ...
  DOUBLE PRECISION,PARAMETER::ep1=0.2d0       !Repulsive force
  DOUBLE PRECISION,PARAMETER::ep2=0.02d0
  DOUBLE PRECISION,PARAMETER::nre=4.d0

  LOGICAL,PARAMETER::flags = .false.       !Activate verbosity
  ...
  LOGICAL,PARAMETER::gradh = .false.      !Includes grad-h terms
  ...
  LOGICAL,PARAMETER::volstdprom=.false.   !Use SPH-avg m/rho (pexp~1)
...
!  DOUBLE PRECISION,PARAMETER::g=6.6726d-8     !Gravitation constant
  ...
  INTEGER::size_neighbors1,size_neighbors2
  ...
  DOUBLE PRECISION,DIMENSION(nmax)::masa,temp,promro,ro2,u,p,c,pro,p0,promro0
  DOUBLE PRECISION,DIMENSION(nmax)::mue,mui,cv,dudv,dpdt,deltax2
  ...
  LOGICAL,DIMENSION(nmax)::outofNRup,outofNRdw,wind
